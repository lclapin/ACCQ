...
<div class="page">
    <ol class="ariane">
        ...
        <li>&nbsp/&nbsp</li>
        <li>Sondage: une constitution, pourquoi?</li>
    </ol>
    <h1 class="titrePage">Sondage: une constitution, pourquoi?</h1>
    <div class="barreP"></div>
    <p>Merci de répondre à ce sondage qui nous permettra de mieux cibler nos actions futures.</p><br>
    <iframe class="sond" src="https://docs.google.com/forms/d/e/1FAIpQLSfy1mtE4lQEfmndzvskL1YYRfLo8pfzh9UddC5HYVYsIvTk9w/viewform?embedded=true" marginheight="0" marginwidth="0" width="640" height="4000" frameborder="0">Chargement en cours…</iframe>
    <div class="ES"><a href="{{ url('pages/mission') }}">Notre engagement, une mission simple</a></div>
    <p>Veuillez prendre le temps nécessaire pour inviter vos ami.e.s à aimer notre page Facebook : <a href="https://www.facebook.com/ConstituanteCitoyenne/">https://www.facebook.com/ConstituanteCitoyenne/</a></p>
