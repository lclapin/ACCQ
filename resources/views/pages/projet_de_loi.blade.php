...
<header>
                ...
                <nav id="navPrinc1">
                    <ul id="navPrinc" class="navPrinc">
                        ...
                        <li><a id="active1" class="elementNav active" href="{{ url('pages/projet_de_loi') }}">Requêtes et recommandations</a></li>
...
<div class="page">
    ...
    <p>Même si nous avons travaillé sur un projet de loi de convocation que nous révisons en ce moment, notre association, l'ACCQ, propose ici l'énumération de principes qui devraient, selon nous, assurer que la rédaction de cette Loi fondamentale se réalisera dans un contexte vraiment démocratique.</p>
    <div class="titreAC">1) LE MANDAT DE LA CONSTITUANTE</div>    
    ...
    <div class="titreAC">2) LE CALENDRIER</div>  
    <p>Nous suggérons un mandat de deux (2) ans pour rédiger le projet de constitution, suivi d’une période ne dépassant pas six (6) mois pour tenir un référendum exécutoire pour ratification.</p>
    <div class="titreAC">3) LA COMPOSITION DE L’ASSEMBLÉE CONSTITUANTE CITOYENNE</div>
    <ol type="a">
        <li><div class="titreli">Sélection par tirage au sort</div><p>Élection ou tirage au sort des personnes constituantes ? Nous pensons qu’un processus ressemblant à une élection générale nuirait à la recherche de consensus citoyens; les personnes élues auraient trop tendance à prendre position en fonction des lignes de parti. De plus, un processus partisan élimine dans les faits les personnes issues des métiers les plus fréquents. C’est-à-dire, pour les hommes : camionneurs, employés du commerce de détail, gérants de magasin, menuisiers-charpentiers, cuisiniers. Et pour les femmes : secrétaires, vendeuses, caissières, éducatrices, infirmières.</p><br>
        ...
        <li>
        <div class="titreli">Parité homme-femme</div>
        <p>Les mécanismes prévus par le texte de loi devraient garantir la parité homme-femme.</p>
        </li>
        <li>
        <div class="titreli">Représentation régionale</div>
        ...
        <li>
        <div class="titreli">Nombre de personnes constituantes</div>
        ...
        <div class="titreli">Hypothèses :</div>
        <ul>
        ...
        <li>
            <div class="titreli">La sélection des personnes constituantes par double tirage au sort</div>
        ...
        <li>
            <div class="titreli">Critères d’admissibilité des membres de la Constituante</div>
        ...
        <li>
            <div class="titreli">Lutte à l’absentéisme — Sièges vacants</div>
...
<div class="titreAC">4) LE FONCTIONNEMENT DE L’ASSEMBLÉE CONSTITUANTE CITOYENNE</div>
    <ol type="a">
        ...
        <li>
        <div class="titreli">Participation citoyenne</div>
        ...
        <li>
        <div class="titreli">Majorité décisionnelle</div>
        ...
        <li>
        <div class="titreli">Finances</div>
        ...
        <li>
            <div class="titreli">Langue de travail</div>
    ...
    <div class="titreAC">5) COMPENSATION FINANCIÈRE POUR LES PERSONNES CONSTITUANTES</div>  
    ...
    <div class="titreli">Explications au sujet de la garantie de réinsertion à l’emploi</div>
    ...
    <div class="titreAC">6) LES DROITS DES PEUPLES AUTOCHTONES</div>  
